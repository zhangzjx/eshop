...
<div id="a">
    ...
    <div class="left-a">
        <li><a href="<c:url value='/ProductServlet?action=findAllOrder'/>" target="right">订单列表</a></li>
    </div>
    <div style="font-size: 12pt;text-align: center;margin: 15px 0px">退款及退货</div>
    <div class="left-a">
        <li><a href="<c:url value='/ProductServlet?action=orderStatus&status=6'/>" target="right">退货申请处理</a></li>
    </div>
    <div class="left-a">
        <li><a href="<c:url value='/ProductServlet?action=orderStatus&status=7'/>" target="right">退款申请处理</a></li>
    </div>

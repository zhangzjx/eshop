...
<div class="goods-main">
    <form  id="myForm" class="brand-form" action="../PhotoServlet" method="post" enctype="multipart/form-data">
        <div id="brand-a" >
            <div class="brand-1" >*品牌名称：</div>
            <div class="brand-2" ><input type="text" id="brand_name" name="brand_name" class="brand-input"/></div>
            <div class="brand-1" >品牌首字母：</div>
            <div class="brand-2" ><input type="text" id="brand_first" name="brand_first" class="brand-input"/> </div>

...
<%
    System.out.println("输出内容"+request.getSession().getAttribute("map"));
%>
<html>
<head>
...
<div class="order-main">
    ...
    <div class="details-top">
        ...
        <div class="details-top-item">
            <img src="img/未完成.png" class="details-top-img" title="这是一张照片"><br><br>
            <strong>支付订单</strong>
        </div>
        <div class="details-top-border border-color"></div>
        <div class="details-top-item">
            <img src="img/未完成.png" class="details-top-img" title="这是一张照片"><br><br>
            <strong>平台发货</strong>
        </div>
    ...
    <div class="order-details">
        <div class="details-1"><span style="margin-left: 10px;float: left;">当前订单状态：待支付</span>
            <div  class="details-item" style="margin-left: 250px" onclick="gkd()">
                修改发票信息
            </div>
            <div class="details-item" onclick="gkd2()">
                修改收货人信息
            </div>
            <div  class="details-item" onclick="gkd3()">
                修改费用信息
            </div>

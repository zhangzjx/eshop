...
<div class="order-main">
    ...
    <div class="order-details">
        <div class="details-1"><span style="margin-left: 10px;float: left;">当前订单状态：已关闭</span>
            <div  class="details-item" style="margin-left: 718px" onclick="gkd()">
                删除订单
            </div>
